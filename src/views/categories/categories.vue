    ...
    <div class="tag-header-container">
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="create" :loading="createLoading"
            >创 建</el-button
          >
        </span>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async confirmEdit(editedContent) {
      ...
      try {
        const result = await update(editedContent._id, editedContent.name);
            ...
            <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="danger" :loading="deleteLoading"
                               @click="deleteCategory(scope.row._id)">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
