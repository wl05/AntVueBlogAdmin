  ...
  <div class="create-container">
    ...
    >
      ...
      <el-form-item label="分类" prop="category">
        <el-select
          v-model="articleContent.category"
      ...
      <el-form-item label="上传图片">
        ...
        <ul v-if="fileList.length > 0">
          <li v-for="file in fileList">{{ file.name }}: {{ file.url }}</li>
        </ul>
      </el-form-item>
      <el-form-item>
        <Editor
      ...
      <el-form-item>
        <el-button :loading="createLoading" type="primary" @click="publish"
          >发布文章</el-button
        >
        <el-button :loading="saveDraftsLoading" @click="saveDrafts"
          >存为草稿</el-button
        >
        <el-button
          v-if="$route.query.id"
          ...
          type="danger"
          @click="deleteArticle($route.query.id)"
          >删除
        </el-button>
      </el-form-item>
    </el-form>
...
=======
    <div class="create-container">
        <el-form :model="articleContent" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="标签" prop="selectedTagValue">
                <el-select v-model="articleContent.selectedTagValue" :loading="listLoading"
                           placeholder="请选择">
                    <el-option
                        v-for="item in tags"
                        :key="item._id"
        ...
        methods : {
            ...
            upLoadSuccess (response, file, fileList) {
                ...
                if (response.code) {
                    ...
                    this.fileList = this.fileList.concat(response.data.files.ops.map((item, index) => {
                        item.url = this.STATIC_DOMAIN + item.url
                        return item
                    }))
                }
