    ...
    >
      ...
      <el-table-column label="状态" width="90">
        <template slot-scope="scope">
          ...
          <el-tag v-else="scope.row.status === '2'" type="success"
          >已发布
          </el-tag
          >
        </template>
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            ...
            type="success"
            @click="
              $router.push({ name: 'Detail', params: { id: scope.row._id } })
            "
          >详情
          </el-button>
        </template>
...
=======
    <div class="tag-container">
        <div class="tag-header-container">
            <el-button @click="$router.push('/article/create')" style="margin-left: 10px;" type="primary"
                       icon="el-icon-edit">
                发布文章
            </el-button>
        </div>
        ...
        >
            ...
            <el-table-column label="状态" width="90">
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.status==='2'" type="danger">删除</el-tag>
                    <el-tag v-else-if="scope.row.publishStatus==='1'">草稿</el-tag>
                    <el-tag v-else="scope.row.status==='2'" type="success">已发布</el-tag>
                </template>
            </el-table-column>
            <el-table-column label="操作" align="center" width="260" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini"
                               @click="$router.push({path:'/article/create',query:{id:scope.row._id}})">编辑
                    </el-button>
                    <el-button :loading="deletingId === scope.row._id && deleteArticleLoading" size="mini" type="danger"
                               @click="deleteArticle(scope.row._id)">删除
                    </el-button>
                    <el-button size="mini" type="success"
                               @click="$router.push({name:'Detail',params:{id:scope.row._id}})">详情
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
