    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          >
          <el-button @click="deleteTag(scope.row._id)" size="mini" type="danger"
          >删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <div class="tag-container">
        <div class="tag-header-container">
            <el-button style="margin-left: 10px;" type="primary" icon="el-icon-edit"
                       @click="createDialogVisible = true">添加
            </el-button>
            <el-dialog
                title="创建标签"
                :visible="createDialogVisible"
            ...
            >
                <el-form :model="tagForm" label-position="right" label-width="80px">
                    <el-form-item label="标签名称" :rules="[{ required: true, message: '请输入标签名', trigger: 'blur' }]">
                        <el-input v-model="tagForm.name"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
        ...
        <el-table
            ...
            <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    <el-button @click="deleteTag(scope.row._id)" size="mini" type="danger">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
